...
namespace LaunchPad\Components\Client\Browser\Browser_Check {
	...
	if(!trait_exists(__NAMESPACE__ . '\\Browser_Check_IsAndroid')){

		// Check if the client browser is "Android Browser", parse it details and store they
		trait Browser_Check_IsAndroid {

			// Check client browser is "Android Browser" or not
			// @no_variable
			// @return Boolean
			public static function Browser_Check_IsAndroid() : Bool {
	...
	return(\LaunchPad\Components\Client\Browser\Browser_Check\Browser_Check_IsAndroid::class);
