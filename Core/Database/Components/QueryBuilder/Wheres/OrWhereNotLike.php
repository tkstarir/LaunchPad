...
namespace LaunchPad\Components\Database\QueryBuilder\Wheres {
	...
	if(!trait_exists(__NAMESPACE__ . '\\OrWhereNotLike')){

		// Or where not like method based on PDO
		trait OrWhereNotLike {
			...
			public static function OrWhereNotLike(?String $column = null, ?String $value = null, ?Callable $closure = null) : \LaunchPad\Database {
	...
	return(\LaunchPad\Components\Database\QueryBuilder\Wheres\OrWhereNotLike::class);
